...
namespace NAudioDemo.AudioPlaybackDemo
{
    ...
    public partial class AudioPlaybackPanel : UserControl
    {
        ...
        private void buttonPlay_Click(object sender, EventArgs e)
        {
            ...
            String.Format("{0:00}:{1:00}:{2:00}", (int)fileWaveStream.TotalTime.TotalMinutes, (int)fileWaveStream.TotalTime.Seconds, (int)fileWaveStream.TotalTime.Milliseconds);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (waveOut != null && fileWaveStream != null)
            {
                ...
                else
                {
                    ...
                    labelCurrentTime.Text = String.Format("{0:00}:{1:00}:{2:00}", (int)currentTime.TotalMinutes, currentTime.Seconds, currentTime.Milliseconds);
                }
            }
            else
            {
